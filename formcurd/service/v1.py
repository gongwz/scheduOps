...
from formcurd.utils.pagination import Pagination
...
class FormcurdModelForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super(FormcurdModelForm, self).__init__(*args, **kwargs)
        # 统一给ModelForm生成字段添加样式
        for name, field in self.fields.items():
            field.widget.attrs['class'] = 'form-control'


class FormcurdForm(forms.Form):

    def __init__(self, *args, **kwargs):
        super(FormcurdForm, self).__init__(*args, **kwargs)
        # 统一给ModelForm生成字段添加样式
        for name, field in self.fields.items():
            field.widget.attrs['class'] = 'form-control'


class FormcurdHandler(object):
    ...
    def display_edit_del(self, obj=None, is_header=None, *args, **kwargs):
        ...
        tpl = '<a href="%s"><button type="button" class="btn btn-info btn-xs">编辑</button></a> <a href="%s"><button type="button" class="btn btn-danger btn-xs">删除</button></a>' % (
    ...
    def get_add_btn(self, request, *args, **kwargs):
        if self.has_add_btn:
            return "<a class='btn btn-success btn-sm' href='%s'>添 加</a>" % self.reverse_add_url(*args, **kwargs)
        return None
    ...
    def get_model_form_class(self, is_add, request, pk, *args, **kwargs):
        ...
        class DynamicModelForm(FormcurdModelForm):
            class Meta:
    ...
    def changelist_view(self, request, *args, **kwargs):
        ...
        return render(
            request,
            self.change_list_template or 'formcurd/changelist.html',
            {
                'data_list': data_list,
    ...
    def add_view(self, request, *args, **kwargs):
        ...
        if request.method == 'GET':
            ...
            return render(request, self.add_template or 'formcurd/change.html', {'form': form})
    ...
    def change_view(self, request, pk, *args, **kwargs):
        ...
        if request.method == 'GET':
            ...
            return render(request, self.change_template or 'formcurd/change.html', {'form': form})
    ...
    def delete_view(self, request, pk, *args, **kwargs):
        ...
        if request.method == 'GET':
            return render(request, self.delete_template or 'formcurd/delete.html', {'cancel': origin_list_url})
...
class FormcurdSite(object):
    def __init__(self):
        self._registry = []
        self.app_name = 'formcurd'
        self.namespace = 'formcurd'
